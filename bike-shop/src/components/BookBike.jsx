...
import BikeAngel from "../images/bike-big/Angel.png";
import BikeAscent from "../images/bike-big/Ascent.png";
import BikeBlackAngel from "../images/bike-big/BlackAngel.png";
import BikeBMC from "../images/bike-big/BMC.png";
import BikeBULIS from "../images/bike-big/BULIS.png";
import BikeDivine from "../images/bike-big/Divine.png";
            ...
            <div className="book-content__box">
              ...
              <form className="box-form">
                <div className="box-form__bike-type">
                  <label>
                    <i className="fa-solid fa-car"></i> &nbsp; Select Your Bike
                    Type <b>*</b>
                  </label>
                  <select value={bikeType} onChange={handleBike}>
                    ...
                    <option value="BULIS">BULIS</option>
